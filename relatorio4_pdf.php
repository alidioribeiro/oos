...
<body>
<font size='20'>
	<cell width='50' align='left'><img src="logo1.jpg" height="50" width="150" /></cell><cell height='40'></cell><br height='2cm' />
</font>
<b>
<font size='14'>
...
$sql   = "SELECT DISTINCT(analista) FROM os WHERE empresa='$empresa' AND data BETWEEN '$dataini' AND '$datafim' AND EXCLUIR='' AND analista NOT IN ('Rodrigo','Francivalda','Edilton') ORDER BY data";
...
{
	$total = 0;
$sql   = "SELECT * FROM os WHERE empresa='$empresa' AND analista='$analistas[$i]' AND data BETWEEN '$dataini' AND '$datafim' AND modulo<>'VIRADA' AND EXCLUIR='' AND analista NOT IN ('Rodrigo','Francivalda','Edilton') ORDER BY data";
$query = $conexaoMYSQL->query($sql);
if($query)
{
